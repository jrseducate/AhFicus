...
public class EntityRenderLightning extends Render<EntityLightning>
{
    public EntityRenderLightning(RenderManager renderManager)
    {
        super(renderManager);
    }
            ...
            for (int j = 0; j < 3; ++j)
            {
                ...
                for (int i1 = k; i1 >= l; --i1)
                {
                    ...
                    for (int j1 = 0; j1 < 5; ++j1)
                    {
                        ...
                        bufferbuilder.pos(d10 + d2, y + (double)(i1 * 16), d11 + d3).color(1.00F, 0.00F, 1.00F, 0.3F).endVertex();
                        bufferbuilder.pos(d8 + d4, y + (double)((i1 + 1) * 16), d9 + d5).color(1.00F, 0.00F, 1.00F, 0.3F).endVertex();
                    }
