package com.jrseducate.ahficus.entity;
...
{
    public static String RegistryName = "lightning";
    ...
    public EntityLightning(World worldIn, double x, double y, double z, boolean effectOnlyIn)
    {
        super(worldIn);
    ...
    public void onUpdate()
    {
        ...
        {
            this.world.playSound(this.player, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_LIGHTNING_THUNDER, SoundCategory.WEATHER, 10000.0F, 0.8F + this.rand.nextFloat() * 0.2F);
            this.world.playSound(this.player, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_LIGHTNING_IMPACT, SoundCategory.WEATHER, 2.0F, 0.5F + this.rand.nextFloat() * 0.2F);
        }
